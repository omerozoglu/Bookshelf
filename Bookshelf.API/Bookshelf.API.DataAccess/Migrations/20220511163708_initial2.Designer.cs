...
namespace Bookshelf.API.DataAccess.Migrations
{
    ...
    [Migration("20220511163708_initial2")]
            ...
            modelBuilder.Entity("Bookshelf.API.Entities.Concrete.BookTransaction", b =>
                {
                    ...
                    b.Property<DateTime?>("LendDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 5, 11, 16, 37, 8, 708, DateTimeKind.Utc).AddTicks(7707));
            ...
            modelBuilder.Entity("Bookshelf.API.Entities.Concrete.BookUser", b =>
                {
                    ...
                    b.Property<DateTime?>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 5, 11, 16, 37, 8, 708, DateTimeKind.Utc).AddTicks(9147));
                    ...
                    b.Property<DateTime?>("UpdateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 5, 11, 16, 37, 8, 708, DateTimeKind.Utc).AddTicks(9312));
            ...
            modelBuilder.Entity("Bookshelf.API.Entities.Concrete.User", b =>
                {
                    ...
                    b.Property<DateTime?>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 5, 11, 16, 37, 8, 709, DateTimeKind.Utc).AddTicks(864));
                    ...
                    b.Property<DateTime?>("UpdateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 5, 11, 16, 37, 8, 709, DateTimeKind.Utc).AddTicks(1010));
